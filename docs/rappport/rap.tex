...
\title{Classification d'images sur CIFAR-10 par r\'eseaux de neurones convolutionnels : structuration des donn\'ees, apprentissage et interpr\'etation du mod\`ele}
...
\begin{abstract}
Ce rapport \'etudie la classification supervis\'ee d'images de CIFAR-10 par r\'eseaux de neurones convolutionnels. L'analyse couvre d'abord la structuration des donn\'ees, la standardisation des images et la d\'efinition d'une architecture de r\'ef\'erence, puis l'\'etude de la dynamique d'apprentissage \`a travers l'effet de la taille du batch et du choix d'optimiseur. Un inventaire raisonn\'e des hyperparam\`etres du mod\`ele, de l'optimisation et du protocole est ensuite \'etabli. Le mod\`ele est alors approfondi par une architecture convolutionnelle plus profonde, \'evalu\'ee sous protocole contr\^ol\'e au moyen de courbes d'apprentissage, de m\'etriques de validation et de matrices de confusion. Le ph\'enom\`ene de sur-apprentissage est ensuite identifi\'e sur les courbes de co\^ut et analys\'e sous l'effet de m\'ecanismes de r\'egularisation. Enfin, des cartes d'activation de la premi\`ere couche et de couches profondes sont visualis\'ees, ainsi que leur \'evolution au cours de l'entra\^inement, afin d'interpr\'eter la hi\'erarchie de repr\'esentations apprises par le CNN.
\end{abstract}

\begin{IEEEkeywords}
Classification d'images, CIFAR-10, r\'eseaux de neurones convolutionnels, apprentissage supervis\'e, hyperparam\`etres, sur-apprentissage, r\'egularisation, cartes d'activation.
\end{IEEEkeywords}
...
\input{sections/DonneStruct.tex}
\input{sections/Architecture.tex}
\input{sections/Learning.tex}
\input{sections/Hyperparameters.tex}
\input{sections/Approfondissement.tex}
\input{sections/Surapprentissage.tex}
\input{sections/CartesActivation.tex}
