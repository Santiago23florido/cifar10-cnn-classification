...
Y. LeCun, ``Convolutional Networks and Applications in Vision,'' presented at ISCAS 2010, accessed Mar. 8, 2026. [Online]. Available: \url{https://cseweb.ucsd.edu/~gary/cs200/s12/lecun-iscas-10.pdf}

\bibitem{cifar10_dataset}
A. Krizhevsky, ``Learning Multiple Layers of Features from Tiny Images,'' CIFAR-10 dataset page, accessed Mar. 8, 2026. [Online]. Available: \url{https://www.cs.toronto.edu/~kriz/cifar.html}

\bibitem{onera_ensta_estimateur_bayesien_slides}
ONERA and ENSTA ParisTech, ``Estimation et Identification statistiques --- Cours 2 : Estimateur Bay\'esien,'' course slides (PDF), Sept. 13, 2023, accessed Mar. 8, 2026. [Course material]. Provided by the user.

\bibitem{yuille_bayes_decision_theory}
A. Yuille, ``Lecture 2. Bayes Decision Theory,'' course Stat 161/261, Johns Hopkins University, Spring 2014, accessed Mar. 8, 2026. [Online]. Available: \url{https://www.cs.jhu.edu/~ayuille1/courses/Stat161-261-Spring14/RevisedLectureNotes2.pdf}

\bibitem{opencv_color_conversions}
OpenCV, ``Color Space Conversions,'' OpenCV Documentation, version 3.4, accessed Mar. 8, 2026. [Online]. Available: \url{https://docs.opencv.org/3.4/d8/d01/group__imgproc__color__conversions.html}

\bibitem{smith_color_gamut_transform_pairs}
A. R. Smith, ``Color Gamut Transform Pairs,'' in \textit{SIGGRAPH '78 Conference Proceedings}, Aug. 1978, pp. 12--19, accessed Mar. 8, 2026. [Online]. Available: \url{https://alvyray.com/Papers/CG/color78.pdf}

\bibitem{opencv_ycrcb_conversion}
OpenCV, ``Color conversions,'' OpenCV Documentation, version 3.4.20-dev, accessed Mar. 8, 2026. [Online]. Available: \url{https://docs.opencv.org/3.4/de/d25/imgproc_color_conversions.html}
\end{thebibliography}
\end{document}
